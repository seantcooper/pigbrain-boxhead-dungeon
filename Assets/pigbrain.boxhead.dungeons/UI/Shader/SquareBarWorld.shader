    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            half4 frag (v2f i) : SV_Target
            {
                ...
                float fillAlpha = aInner * fillMask * _Color.a;

                float backgroundAlpha = aInner * (1 - fillMask) *
                    _BackgroundColor.a;

                float3 col =
                    _Color.rgb * fillAlpha +
                    _BackgroundColor.rgb * backgroundAlpha +
                    _OutlineColor.rgb * outlineAlpha;

                float alpha = max(fillAlpha + backgroundAlpha, outlineAlpha * _OutlineColor.a);
